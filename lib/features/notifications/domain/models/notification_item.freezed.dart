...
class _$NotificationItemImpl implements _NotificationItem {
  ...
  @override
  String toString() {
    return 'NotificationItem(id: $id, title: $title, body: $body, createdAt: $createdAt, isRead: $isRead, workId: $workId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, body, createdAt, isRead, workId);
