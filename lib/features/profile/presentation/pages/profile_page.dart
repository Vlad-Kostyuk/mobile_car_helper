...
import 'package:car_helper/features/auth/presentation/auth_cubit.dart';
import 'package:car_helper/features/profile/domain/model/user_profile.dart';
import 'package:car_helper/features/profile/presentation/model/profile_view_model.dart';
import 'package:car_helper/features/profile/presentation/profile_cubit.dart';
import 'package:car_helper/shared/theme/app_colors.dart';
import 'package:car_helper/shared/widgets/auth_text_field.dart';
  ...
  Widget build(BuildContext context) {
    return _Card(
      children: [
        ...
        _Divider(),
        _InfoRow(label: 'Email', value: profile.email, isReadOnly: true),
      ],
    );
  }
}
