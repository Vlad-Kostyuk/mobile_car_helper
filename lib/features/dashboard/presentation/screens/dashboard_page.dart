...
import '../../../../shared/ui_kit/app_drawer.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            context.l10n.dashboardSelectedCar,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          child: _ActionButton(
            label: context.l10n.dashboardAddWork,
          ...
          children: [
            Expanded(
              child: _MaintenanceCard(
                ...
                title: 'ЗАМІНА\nМАСТИЛА',
                value: '500',
                unit: context.l10n.dashboardMileageUnit,
                badge: context.l10n.dashboardBadgeSoon,
                isUrgent: true,
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: _MaintenanceCard(
                ...
                value: '2,140',
                unit: context.l10n.dashboardMileageUnit,
                badge: context.l10n.dashboardBadgePlanned,
                isUrgent: false,
              ),
            ),
          ],
            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text(
                    context.l10n.dashboardCurrentMileage,
                    style: GoogleFonts.inter(
                      fontSize: 14,
              ...
              RichText(
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: context.l10n.dashboardMileageUnit,
                      style: GoogleFonts.inter(
                        fontSize: 14,
                        color: AppColors.cardDark,
                      ),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            context.l10n.dashboardCarHealth,
            style: GoogleFonts.manrope(
              fontWeight: FontWeight.w700,
              fontSize: 22,
              color: AppColors.textPrimary,
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                context.l10n.dashboardRecentServices,
                style: GoogleFonts.inter(
                  fontSize: 13,
                  color: AppColors.textSecondary,
                  letterSpacing: 0.3,
            ...
            children: [
              ...
              if (isDone)
                Container(
                  ...
                  child: Text(
                    context.l10n.dashboardBadgeDone,
                    style: GoogleFonts.inter(
                      fontWeight: FontWeight.w700,
                      fontSize: 10,
      ...
      child: SafeArea(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              _NavItem(icon: Icons.directions_car_rounded, label: context.l10n.dashboardNavStatus, isActive: true),
              _NavItem(icon: Icons.calendar_today_rounded, label: context.l10n.dashboardNavCalendar, isActive: false),
              _NavItem(icon: Icons.build_rounded, label: context.l10n.dashboardNavServices, isActive: false),
              _NavItem(icon: Icons.notifications_outlined, label: context.l10n.dashboardNavNotifications, isActive: false),
            ],
          ),
        ),
      ),
